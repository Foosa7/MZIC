...
class App(customtkinter.CTk):
    def __init__(self, params, headings, heaterid6x6, heaterid8x8, options, globalcurrrentlimit):
        ...
        self.currentheaterid = self.heaterid6x6
        self.val = '6x6' 
        self.options = options
        ...
        self.scrollable_frame = MyScrollableFrame(self.tab_view.tab("Calibrate"), title = "Channel configuration", params=self.params, heaterid=self.currentheaterid, config = 6*5, app = self)
